...
public partial class MetodoSecanteFRM : Form
{
    ...
    private void Form1_Load(object sender, EventArgs e)
    {
        ...
        lstResultados.Columns.Add("Xi", 127, HorizontalAlignment.Center);
        lstResultados.Columns.Add("F(Xi)", 127, HorizontalAlignment.Center);
        lstResultados.Columns.Add("Raiz Aprox",127,HorizontalAlignment.Center);
        lstResultados.Columns.Add("Error Aprox",127,HorizontalAlignment.Center);
    ...
    private void btnCalcular_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                ms.MetodoSecanteEv(eqq, Convert.ToDouble(txtXi.Text), Convert.ToDouble(txtXo.Text),
        ...
        lstResultados.DrawSubItem += (s, e) =>
        {
            ...
            if (e.ItemIndex == lastRowIndex && (e.ColumnIndex == 1 || e.ColumnIndex == 2 || e.ColumnIndex==3 || e.ColumnIndex==4))
            {
