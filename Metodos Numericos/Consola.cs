...
public class Consola 
{
    public static void Main(string[] args)
    {
        ...
        //     Console.WriteLine("1. BiseccionIO \n2. Posicion Falsa \n3. Punto Fijo \n4. Newton Raphson \n5. Secante  \n6. Newton Raphson-SENL\n0. Determinar el mas optimo");
        //     Console.WriteLine("7. Salir");
        //     menu = int.Parse(Console.ReadLine());
        //     switch (menu)
        //     {
        //         case 1:
        //             Console.WriteLine("Metodo de BiseccionIO");
        //             Console.WriteLine("Por favor ingrese la funcion");
        //             eqq = Console.ReadLine();
        //             var expreB = Infix.ParseOrThrow(eqq);
        ...
        //             eqq = Console.ReadLine();
        //             var expre = Infix.ParseOrThrow(eqq);
        //             Console.WriteLine("Ingrese el limite inferior, para los metodos BiseccionIO y Posicion Falsa");
        //             double limInfTe = double.Parse(Console.ReadLine());
        //             Console.WriteLine("Ingrese el limite superior, para los metodos BiseccionIO y Posicion Falsa");
