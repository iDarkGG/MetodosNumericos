...
public class BiseccionIO
{
    private HerramientasCalculo hr = new HerramientasCalculo();
    private static List<BiseccionIO> _lista = new List<BiseccionIO>();

    public BiseccionIO(){}
    
    public BiseccionIO(Expression expression, double error, int contador, double result)
    {
    ...
    public void Agregar(BiseccionIO biseccionIo)
    {
        _lista.Add(biseccionIo);
    }
